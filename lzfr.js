(() => {
  let retry = 0;
  function waitLZFR() {
    if (typeof window.lzfr != "undefined" && retry < 6) {
      window.lzfr.getSubmitForm = function (submission, formObj) {
        let formData = {};
        ...
        let valParamUtmCampaign = this.getUrlParameter(
          PROPERTY_NAME.UtmCampaign
        );
